package com.example.shanpin.ui.tool;
 ...
 */
public class TwoPopupWindow extends PopupWindow implements Serializable {
    ...
    public TwoPopupWindow(Activity context, View.OnClickListener selectListener, View.OnClickListener captureListener) {
        super(context);
